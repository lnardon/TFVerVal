...
public class CalculoCustoViagemRelampagoTest {
    ...
    // TESTE AQUI LEIFHEIT
    @ParameterizedTest
    @CsvSource({ "200,32,4.0", "120,20,0.0", "10,31,0.0", "100,15,0.0", "150,30,0.0" }) // MUDAR?
    public void descontoPontuacaoRelampagoTest(int pontuacaoAcumulada, int qtdadeAvaliacoes, double expected) {
        ...
        Passageiro passageiro = Passageiro.passageiroExistente("7474747", "Lucas", pontuacaoAcumulada,
                qtdadeAvaliacoes);
